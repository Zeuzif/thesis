...
Ce chapitre rassemble les ressources pour mener l'expression des besoins, nous allons commencé par l'identification des acteurs, puis nous passons à la spécification des besoins et faire une analyse en s'appuyant sur UML, enfin nous donnons un aperçu sur l'algorithme de jumelage qui est le cœur de notre métier.
...
\begin{center}
    ...
    \end{tabular}
\end{center}
\fig{sequence_insc.png}{diagramme de séquence inscription}{0.25}
...
\fig{classe.png}{diagramme de classe métier}{0.5}
