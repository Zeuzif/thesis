...
\fig{classe.png}{diagramme de classe métier simplifié}{0.7}\newline
...
La figure \Figref{logigramme.png} décrit étape par étape les différents taches. Notant que ce processus se répète trois fois, si aucune offre n'est trouvée on notifie le passager, dans ce cas il a la possibilité de relancer la recherche manuellement.
