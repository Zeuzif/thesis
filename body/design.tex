...
Pour identifier les éléments du domaine et les relations et interactions entre ces éléments, le diagramme de classe fournit une représentation des entités du système qui vont interagir pour réaliser les cas d'utilisation.\clearpage
...
\figlabel{logigramme.png}{logigramme du processus de matching}{0.7}{logigramme}\newline
