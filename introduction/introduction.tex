...
Donc, notre solution consiste à automatiser cette opération, en optimisant les temps de détour du chauffeur tout en laissant un maximum de chance aux passagers de trouver un conducteur qui va les amenés vers leurs destinations tout en nouant les liens sociaux qui sont en déclin.
...
L'application proposes les chemins les plus optimaux avec des temps de détour pour prendre un passager, courts et rapides. Dans le but de réduire la consommation d’énergie et par conséquence, réduire l’émission des gazes polluants.
